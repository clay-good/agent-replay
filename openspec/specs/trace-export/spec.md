...
- **WHEN** a store holds a good run and a regressed run of the same agent and input, and both are exported as a golden baseline
- **THEN** the export reports that entries share a key and that a candidate matching any of them passes
